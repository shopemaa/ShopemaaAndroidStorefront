package com.shopemaa.android.storefront.contants

object Constants {
    const val storeKeyLabel: String = "storeKey"
    const val storeSecretLabel: String = "storeSecret"
    const val indexHome: Int = 1
    const val indexOrder: Int = 2
